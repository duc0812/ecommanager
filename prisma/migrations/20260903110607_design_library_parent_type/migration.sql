...
INSERT INTO "new_SkuSupplierDesign" ("createdAt", "designLink", "id", "note", "ready", "sku", "source", "supplierId", "trelloCardId", "updatedAt") SELECT "createdAt", "designLink", "id", "note", "ready", "sku", "source", "supplierId", "trelloCardId", "updatedAt" FROM "SkuSupplierDesign";
